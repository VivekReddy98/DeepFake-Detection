# Taken From https://github.com/guillaumegenthial/tf_metrics
...
def precision(labels, predictions, weights=None, mask = None, num_classes=2, pos_indices=None,
              average='micro'):
...
def recall(labels, predictions, num_classes=2, pos_indices=None, weights=None,
           average='micro'):
...
def f1(labels, predictions, num_classes=2, pos_indices=None, weights=None,
       average='micro'):
